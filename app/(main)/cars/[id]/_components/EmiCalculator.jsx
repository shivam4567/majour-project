        ...
        <div className="space-y-4">
          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4">
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-lg font-inter font-semibold text-gray-900 dark:text-white">
                Vehicle Price
              </h2>
              <div className="flex items-center gap-1 text-amber-600 dark:text-amber-500 text-sm font-medium">
            ...
            <div className="space-y-3">
              <div className="relative">
                ...
                <input
                  ...
                  value={loanAmount}
                  disabled
                  className="w-full pl-8 pr-4 py-2 rounded-md border border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white focus:outline-none cursor-not-allowed opacity-75"
                />
              </div>
              <input
                type="range"
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 italic">
                Car price is fixed and cannot be changed
              </p>
            </div>
          </div>
